...
// Define default gear
_defItems = ["kat_guedel", "cup_optic_g36optics_rds", "cup_optic_g36optics_rds_3d", "CUP_NVG_PVS15_black", "ACE_adenosine", "ACE_fieldDressing", "ACE_elasticBandage", "ACE_packingBandage", "ACE_quikclot", "ACE_epinephrine", "ACE_Flashlight_MX991", "ACE_MapTools", "ACE_morphine", "ACE_splint", "ACE_tourniquet", "ItemMap", "ItemCompass", "ItemWatch"];
