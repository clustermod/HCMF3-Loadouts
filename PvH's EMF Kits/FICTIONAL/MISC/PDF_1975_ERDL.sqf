...
_defMagazines = ["Tier1_250Rnd_762x51_Belt_M80", "CUP_30Rnd_556x45_Stanag", "rhs_mag_M397_HET", "rhs_mag_M433_HEDP", "rhs_mag_M441_HE"];
_defGrenades = [];
_defUniforms = ["rhs_uniform_bdu_erdl"];
_defWeapons = [];
_defVests = ["rhsgref_alice_webbing"];
_defBackpacks = [];
_defHeadgear = ["rhsgref_helmet_pasgt_erdl"];
_defFacewear = ["LEN_BCG"];
