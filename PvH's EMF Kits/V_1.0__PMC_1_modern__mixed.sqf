...
_defGrenades = [ "Chemlight_green", "Chemlight_blue", "ACE_Chemlight_IR", "Chemlight_red", "ACE_Chemlight_Orange"];
_defUniforms = [];
_defWeapons = [];
_defVests = [];
_defBackpacks = [];
...
// This kit includes multiple different VIP's that have 
...
if (_role == "RFL") then
{
	...
	_availableMagazines = ["rhs_30Rnd_762x39mm_Savz58", "CUP_30Rnd_Sa58_M", "CUP_30Rnd_Sa58_M_TracerG"];
	...
	_availableHeadgear = ["tc2002_s", "tc2002_p", "tc2002od2", "tc2002_od", "tc2002_sm"];
...
{
	_availableUniforms = [];
	_availableWeapons = ["rhsusf_bino_m24", "rhssaf_zrak_rd7j"];
	_availableMagazines = [];
	_availableVests = [];
	_availableItems = [];
	_availableBackpacks = [];
...
{
	_availableUniforms = [];
	_availableWeapons = ["rhs_weap_rpg75"];
	_availableMagazines = [];
	_availableVests = [];
	_availableItems = [];
	_availableBackpacks = [];
