...
private _defMagazines = ["CUP_30Rnd_556x45_Stanag_Tracer_Green", "CUP_100Rnd_TE4_LRT4_Green_Tracer_762x51_Belt_M", "UK3CB_BAF_762_200Rnd_T", "rhs_mag_m715_Green", "rhs_mag_M441_HE", "rhs_mag_m713_Red", "ACE_40mm_Flare_white", "rhs_mag_m661_green", "rhs_mag_m662_red"];
private _defGrenades = ["rhs_mag_m67", "Chemlight_green"];
private _defUniforms = ["Portugal_Lizard_B"];
private _defWeapons = [];
private _defVests = ["rhsgref_alice_webbing", "rhsgref_chicom", "rhsgref_chestrig"];
private _defBackpacks = ["CUP_B_AlicePack_OD"];
private _defHeadgear = ["usm_bdu_boonie_odg", "Portugal_lizard_Booniehat_Green"];
